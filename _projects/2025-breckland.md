...
img: assets/img/2025-breckland-bg.jpg
importance: 3
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-fig1.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Figure 1 Map of Breckland area. (a) Present-day geology of East Anglia with the Breckland area outlined in red (adapted from Bateman et al., 2014). (b) Distribution of patterned ground in East Anglia as mapped by Nicholson (1969) (adapted from Bateman et al., 2014). (c) Study area with 14 UAV survey sites labeled. Drone restriction zones are shown as dashed orange circles or polygons. Primary field investigation sites are marked with red stars. Green rectangles highlight areas with extensive patterned ground, which are enlarged in Figure 2. This map is based on satellite imagery, aerial photos, and previous literature and serves as an indicative, non-scaled reference.
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-fig2a.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-fig2bc.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Figure 2. Detailed distribution of patterned ground types in the areas highlighted by green rectangles in Figure 1c, around (a) Weather heath, (b) Elveden and Berner’s heath, (c) Snarehill, Barham spinney and Euston.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-table1.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Table 1. Site selection for UAV and field surveys. All sites will undergo UAV mapping, while only a subset will be selected for field investigations. Primary field survey sites are highlighted in brown.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-table2.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Table 2. Transect allocation by pattern type, specifying the number per site and orientation criteria.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-table3.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Table 3. Laboratory analysis plan and sample distribution for different sediment types. Relevant references for analytical techniques are included.  
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-app1.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-breckland-app2.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
</div>
